...
function ledgerServiceType(group: 'wash' | 'addon' | 'manual' | 'custom', code: string): 'wash' | 'detailing' | 'other' {
...
async function postToAccountingLedger(
  ...
  serviceRows: { service_group: 'wash' | 'addon' | 'manual' | 'custom'; service_code: string; service_name: string; price: number }[]
) {
